											...
											<div class="table-responsive table-lg text-nowrap">
												<table class="table table-bordered">
													...
													<tbody>
														...
														?>
														<form action="adminDeleteComment.php" method="post">
														<tr>
															<input type="hidden" name="id" value="<?php echo $row['id']; ?>">
															<td class="text-dark"><?php echo $row['idUser']; ?></td>
															<td><?php echo $row['idProduit']; ?></td>
															<td class="fw-600"><?php echo $row['comment']; ?></td>
															<td class="fw-600"><?php echo $row['date']; ?></td>
															<td class="text-center"><input class="btn btn-danger" type="submit" name="delete-comment" value="supprimer"></td>
														</tr>
													</form>
														<?php } ?>
													</tbody>
