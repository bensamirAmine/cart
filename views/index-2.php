...
$Ppanier1C = new ProduitPanierC();
$wishlist1C= new WishlistC();
$productPL = $panier1C->plusAjouter();
$productP= $productPL['idProduit'];
$topWishList=$wishlist1C->plusAjouter();
$topWish= $topWishList['idProduit'];
$topWishDetails=$Ppanier1C->getProductDetailsByIdProduit($topWish);
$productPDetails=$Ppanier1C->getProductDetailsByIdProduit($productP);
$topWishname=$topWishDetails['name'];
$productPname =$productPDetails['name'];
							...
							<div class="col-lg-6 col-xl-3 col-md-6 col-12">
								<div class="card">
									<div class="card-body text-center">
										...
										<div class="">
											<h4 class="mt-2 mb-3"><?php echo $productPname; ?></h4>
											<div class="">
									...
									<div class="card-footer">
										<div class="float-left">
											<p class="mb-0"><span class=""><i class="fa fa-arrow-circle-o-up ml-1 text-success"></i> 2.5%</span>  </p>
										</div>
										<div class="float-right">
							...
							<div class="col-lg-6 col-xl-3 col-md-6 col-12">
								<div class="card">
									<div class="card-body text-center">
										...
										<div class="">
											<h4 class="mt-2 mb-3"><?php echo $topWishname; ?></h4>
											<div class="">
