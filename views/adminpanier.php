...
$listePanier = $panier1C->afficherpaniers();
?>

<!DOCTYPE html>
<html lang="en">
	
<!-- Mirrored from www.spruko.com/demo/splite/order.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:33:23 GMT -->
<head>
				...
				<div class="app-content">
					<section class="section">
						...
						<div class="page-header">
							<h4 class="page-title">Listes des paniers</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#" class="text-light-color">Components</a></li>
												...
												<table class="table table-bordered">
													...
													<tbody>
														...
														foreach ($listePanier as $row) {
															$totalPrix=$panier1C->totalPriceInCartByidPanier($row['idPanier']);
														?>
														<tr>
															<td class="text-dark"><?php echo $row['idPanier']; ?></td>
															<td><?php echo $row['dateCreation']; ?></td>
															<td>3</td>
															<td><span class="badge badge-success m-b-5"><?php echo $row['etat']; ?></span></td>
															<td class="fw-600"><?php echo $row['somme']; ?></td>
															<td class="text-center"><a href="#" class="btn btn-primary btn-sm">View Details</a></td>
														</tr>
														<?php } ?>
													</tbody>
												</table>
